...
- Inventory: Starter-11 — probable *Euphorbia obesa*-type hybrid or selection
- Identification: **probable; exact parentage unknown**
- Photo archive: [licensed *E. obesa* reference images](../../../assets/plants/euphorbia-obesa-hybrid/)

## Identity and the important correction

| Kind | Name |
| --- | --- |
| Best working ID | *Euphorbia obesa*-type hybrid or horticultural selection |
...
- [Kew Plants of the World Online: *Euphorbia obesa*](https://powo.science.kew.org/taxon/urn%3Alsid%3Aipni.org%3Anames%3A347540-1)
- [SANBI PlantZAfrica: *Euphorbia obesa* history, ecology, and cultivation](https://pza.sanbi.org/euphorbia-obesa)
