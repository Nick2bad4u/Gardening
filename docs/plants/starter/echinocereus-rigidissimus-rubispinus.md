...
| Kind                             | Name                                                                           |
| -------------------------------- | ------------------------------------------------------------------------------ |
| Accepted botanical name          | _Echinocereus rigidissimus_ subsp. _rubispinus_ (G.Frank & A.B.Lau) N.P.Taylor |
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Grow-light position | **R3C5 · High.** September 15, 2026 photo layout, facing the window (six columns, four rows). Interior-right stronger-light priority. Keep a clear overhead path to the crown. See the [current placement guide](../../layouts/table-placement-research.md). |
