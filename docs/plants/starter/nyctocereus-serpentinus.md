...
This species is native across large parts of Mexico and grows in seasonally dry
tropical vegetation. Unlike a compact desert ball cactus, it is a scrambling
shrub: slender ribbed stems can reach several metres by leaning through other
plants. Underground, established specimens may develop enlarged roots that
store water and energy through dry periods.
...
fresh yellow or tan patches mean the increase was too abrupt.

## Propagation and watch points

- Stem cuttings root readily after the cut end has dried and callused. Seed
  preserves genetic variation and can eventually form the characteristic
  storage root.
- Long stems make leverage. Secure the pot before a top-heavy stem pulls on the
  root ball.
- The plant can be pruned for space. A healthy removed section can become a
  cutting rather than being discarded.
- Night flowers may be missed if the plant is only checked during the day.
  Swelling buds are a reason to look after dusk and again early in the morning.
- Watch warm crevices for mealybugs and the base for softness.
