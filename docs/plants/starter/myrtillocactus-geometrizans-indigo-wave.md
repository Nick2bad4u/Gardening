...
- Inventory: Starter-09 — *Myrtillocactus geometrizans* 'Indigo Wave'
...
| Kind | Name |
| --- | --- |
| Underlying accepted species | *Myrtillocactus geometrizans* (Mart. ex Pfeiff.) Console |
...
Wild *M. geometrizans* is a blue-green, candelabra-shaped cactus tree native to
...
the genus name: *Myrtillocactus* compares the fruits with bilberries or small
myrtle berries. *geometrizans* alludes to the geometric regularity of the normal
