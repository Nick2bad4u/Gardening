...
| Kind                        | Name                                                                                    |
| --------------------------- | --------------------------------------------------------------------------------------- |
| Underlying accepted species | _Myrtillocactus geometrizans_ (Mart. ex Pfeiff.) Console                                |
| Collection trade name       | Indigo Wave                                                                             |
...
Wild _M. geometrizans_ is a blue-green, candelabra-shaped cactus tree native to
Mexico. It occurs in seasonally dry habitats from north-central into southern
parts of the country and can grow several metres tall. The waxy bloom responsible
for its blue cast also helps reduce water loss and excessive light at the stem
surface.
...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Grow-light position | **Photo-matched R1C5 · High.** September 15 six-column/four-row front grid, facing the window. Front row near the right. This stronger-light priority is no longer at the old interior slot; compare it with C2 before proposing a swap. See the [current placement guide](../../layouts/table-placement-research.md); labels and intensity remain to be checked. |
...
moisture. Healthy new monstrose tissue can still be compact, firm, and strongly
colored even though it is not symmetrical.

## Propagation and watch points

- Stem pieces can be rooted after a clean cut has fully callused. Cuttings are
  the practical way to preserve this exact monstrose form.
- A normal-looking column may be a reversion. It can be left for contrast or
  removed if preserving the compact form is the priority.
- Scale and mealybugs hide in folds. Use a light and magnifier instead of
