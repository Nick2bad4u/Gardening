...
| Grow-light position        | **Planned on a floor pot stool, off the tables.** No completed move is reported; stool height, actual position, clearance, and leaf-height exposure remain unmeasured. The far-table **18–22 app-estimated DLI** does not measure this planned position. Preserve the existing cactus arrangement.                                                                                                                                           |
