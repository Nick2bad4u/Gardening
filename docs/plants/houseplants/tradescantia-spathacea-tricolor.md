...
The owner plans to move this plant and **P31 / #7 Peperomia Bicolor** to a **north-facing living-room window**, using two owned 10 W LED bars and one additional owned 10 W LED light to supplement daylight. This is a separate destination from Money Tree's recorded windowsill in the cactus room. The move and light installation remain pending; exact light models, timer, distances, and canopy coverage are unrecorded. The owner is considering 20 W three-head alternatives if the existing lights prove inadequate. See the [living-room measurement trial](../../layouts/table-placement-research.md#planned-living-room-window-and-leds).
...
| Grow-light position        | **Last confirmed September 20 on the room-side floor near the money tree.** The September 21 plan is the living-room north window with the three owned LED lights; move and installation remain pending. Stool choice, clearances, timer, and leaf-height exposure are unmeasured. The cactus-table readings do not establish exposure at either position.                                                                                   |
...
For the proposed living-room trial, 6–8 DLI over a constant **14-hour** light period is approximately **119–159 µmol·m⁻²·s⁻¹**. A **12–14-hour daytime window** is a suggested starting schedule, not an installed timer setting. Compare LED-only estimates after dark across the foliage, and assess variable daylight separately; a single noon reading multiplied by the timer is not a measured daily integral. Acclimate gradually and judge compact growth and color; neither the starting nor the optional settled range establishes a minimum, optimum, or burn threshold. The old cactus-room timer and room conditions do not measure the planned living-room exposure.
...
- Owner plan on September 21, 2026: move P31/P32 to a living-room north-facing window with two owned 10 W LED bars and another owned 10 W LED light; 20 W three-head alternatives considered. Models, distances, schedule, installation, and completed move remain unconfirmed.
