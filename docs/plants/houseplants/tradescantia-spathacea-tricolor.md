...
The owner plans to move this plant and **P31 / #7 Peperomia Bicolor** to a **north-facing living-room window**, using the **FECiDA 54 W six-tube clip light purchased September 21 alongside the existing lights**. On **September 22**, the owner identified those as **two Juhefa three-head fixtures, each seller-rated about 10 W total**, with the separate **Diivoo optional**. The Juhefa rating covers the whole fixture; the Diivoo's actual input wattage remains unverified. The [equipment inventory](../../equipment/inventory.md#lights-and-controls) records the exact models and FECiDA's September 23 delivery estimate last checked September 21. This is a separate destination from Money Tree's recorded windowsill in the cactus room. Receipt, the move, and installation remain pending; final settings, distances, and canopy coverage are unrecorded. See the [living-room measurement trial](../../layouts/table-placement-research.md#planned-living-room-window-and-leds).
...
| Grow-light position        | **Last confirmed September 20 on the room-side floor near the money tree.** The September 21 plan, clarified September 22, is the living-room north window with the new FECiDA and two Juhefa fixtures, plus the Diivoo if used; move and installation remain pending. Stool choice, clearances, applied settings, and leaf-height exposure are unmeasured. The cactus-table readings do not establish exposure at either position.          |
...
For the proposed living-room trial, 6–8 DLI over a constant **12-hour** light period is approximately **139–185 µmol·m⁻²·s⁻¹**. A **12-hour daytime trial** matches the listed timers on the FECiDA, Juhefas, and optional Diivoo. Align whichever lights are used to the same window; no applied setting has been reported. The DLI comparison includes lamps plus daylight, so these PPFD equivalents are not an extra LED quota on top of window light. Compare estimates with **the fixtures actually used on together after dark** across the foliage, and assess variable daylight separately; a single noon reading multiplied by the timer is not a measured daily integral. Acclimate gradually and judge compact growth and color; neither the starting nor the optional settled range establishes a minimum, optimum, or burn threshold. The old cactus-room timer and room conditions do not measure the planned living-room exposure.
