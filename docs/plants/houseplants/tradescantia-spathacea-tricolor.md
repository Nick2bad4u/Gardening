...
The owner plans to move this plant and **P31 / #7 Peperomia Bicolor** to the living room. On **September 22**, the owner clarified and confirmed **side-by-side placement at a north-facing double glass sliding door**, with **P32 closest to the glass**, **P31 raised on the smallest Bamworld stool** to reduce daylight obstruction, and the **FECiDA 54 W six-tube light clipped to a shelf**. The smallest stool is seller-listed at 7.8 inches; actual leaf heights, shelf height, and lamp clearances are unmeasured. This is a separate destination from Money Tree's recorded windowsill in the cactus room.

The September 21 intention was to combine the new FECiDA with the existing lights, identified September 22 as **two Juhefa three-head fixtures, each seller-rated about 10 W total**, and a separate **optional Diivoo** whose actual input power is unverified. For the confirmed adjacent layout, the **recommended first trial is FECiDA alone for 12 daytime hours**, keeping Juhefas available for dim areas if repositioning the six heads does not give enough coverage. The [equipment inventory](../../equipment/inventory.md#lights-and-controls) records the exact models and FECiDA's September 23 delivery estimate last checked September 21. Receipt, the completed move, and installation remain unconfirmed; final fixture selection, settings, distances, and canopy coverage are unrecorded. See the [living-room measurement trial](../../layouts/table-placement-research.md#planned-living-room-window-and-leds).
...
| Grow-light position        | **Last confirmed September 20 on the room-side floor near the money tree.** Planned September 22: closest to the glass, beside P31 on the smallest Bamworld stool, at the living-room north-facing sliding glass door. FECiDA clips to a shelf; try it alone first, with Juhefa fill only if needed. Move and installation remain pending; actual leaf-height exposure and clearances are unmeasured.                                        |
...
For the proposed living-room trial, 6–8 DLI over a constant **12-hour** light period is approximately **139–185 µmol·m⁻²·s⁻¹**. A **12-hour daytime trial** matches the listed timers on the FECiDA, Juhefas, and optional Diivoo. Align whichever lights are used to the same window; no applied setting has been reported. The DLI comparison includes lamps plus daylight, so these PPFD equivalents are not an extra LED quota on top of window light. For the recommended first trial, measure **the FECiDA alone after dark** at this plant's actual leaf height, then remeasure all selected fixtures together if adding fill. Compare across the foliage, and assess variable daylight separately; a single noon reading multiplied by the timer is not a measured daily integral. Acclimate gradually and judge compact growth and color; neither the starting nor the optional settled range establishes a minimum, optimum, or burn threshold. The old cactus-room timer and room conditions do not measure the planned living-room exposure.
...
- Owner evidence on September 21–22, 2026: planned P31/P32 living-room move and FECiDA six-tube purchase. On September 22 the owner confirmed adjacent positions at the north-facing double glass sliding door, P32 closest to the glass, P31 on the smallest stool, and FECiDA clipped to a shelf. The September 22 links identify **two Juhefa three-head fixtures, seller-rated about 10 W each**, and the separate **Diivoo, now optional**. The [equipment record](../../equipment/inventory.md#lights-and-controls) cites the exact listings, wattage limitations, timer choices, and dated arrival estimate; receipt, final settings/distances, installation, and completed move remain unconfirmed.
