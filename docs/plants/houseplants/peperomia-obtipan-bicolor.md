...
The owner plans to move this plant and **P32 / #8 Tricolor oyster plant** to the living room. On **September 22**, the owner clarified and confirmed **side-by-side placement at a north-facing double glass sliding door**, with **P32 closest to the glass**, **P31 raised on the smallest Bamworld stool** to reduce daylight obstruction, and the **FECiDA 54 W six-tube light clipped to a shelf**. The smallest stool is seller-listed at 7.8 inches; actual leaf heights, shelf height, and lamp clearances are unmeasured. This is a separate destination from Money Tree's recorded windowsill in the cactus room.
...
| Grow-light position        | **Last confirmed September 20 on the room-side floor near the money tree.** Planned September 22: on the smallest Bamworld stool beside P32, which is closest to the glass, at the living-room north-facing sliding glass door. FECiDA clips to a shelf; try it alone first, with Juhefa fill only if needed. Move and installation remain pending; actual leaf-height exposure and clearances are unmeasured.        |
...
For the proposed living-room trial, 4–6 DLI over a constant **12-hour** light period is approximately **93–139 µmol·m⁻²·s⁻¹**. A **12-hour daytime trial** matches the listed timers on the FECiDA, Juhefas, and optional Diivoo. Align whichever lights are used to the same window; no applied setting has been reported. The DLI comparison includes lamps plus daylight, so these PPFD equivalents are not an extra LED quota on top of window light. For the recommended first trial, measure **the FECiDA alone after dark** at this plant's actual leaf height, then remeasure all selected fixtures together if adding fill. Compare across the foliage, and assess variable daylight separately; a single noon reading multiplied by the timer is not a measured daily integral. Acclimate gradually and judge new growth; neither the starting nor the optional settled range establishes a minimum, optimum, or burn threshold. The old cactus-room timer and room conditions do not measure the planned living-room exposure.
