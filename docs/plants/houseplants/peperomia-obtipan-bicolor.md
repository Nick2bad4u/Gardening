...
| Grow-light position        | **Planned on a floor pot stool, off the tables.** The move is not reported complete; actual position, stool height, clearance, and leaf-height exposure are unmeasured. The far-table **18–22 app-estimated DLI** does not measure this planned position. Keep the existing cactus arrangement intact.                                                                                                                |
...
For comparison with the owner's light app, 4–6 DLI over a constant 13-hour day is approximately **85–128 µmol·m⁻²·s⁻¹**. This arithmetic does not measure the actual 13 h 15 m program or its sunrise/sunset ramps. Compare readings at the leaves, acclimate gradually, and judge new growth; no upper trial number is a proven burn threshold.
