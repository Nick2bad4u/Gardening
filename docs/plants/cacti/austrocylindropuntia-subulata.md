...
| Kind                    | Name                                           |
| ----------------------- | ---------------------------------------------- |
| Accepted botanical name | _Austrocylindropuntia subulata_                |
...
The species comes from the Andean region of western South America. NC State
Extension describes it as a shrub- or tree-like cactus with cylindrical,
tubercled stems, awl-shaped leaves, sharp spines, and irritating glochids on
the fruit. A container plant stays smaller than a mature plant in habitat but
can eventually outgrow a compact tabletop display.

GBIF treats _A. subulata_ as an accepted species. The current combination was
published in 1942; older references may place it in _Opuntia_ or
_Cylindropuntia_.
...
| Grow-light position | **Proposed R4C4 · High.** Retain the lower-right interior. Keep upright growth from shading B3, G2, H1, or the low glass planters. See the [relative-light placement guide](../../layouts/table-placement-research.md). Placement and intensity remain to be verified. |
