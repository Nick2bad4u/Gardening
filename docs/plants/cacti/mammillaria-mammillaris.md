...
| Kind                   | Name                             |
| ---------------------- | -------------------------------- |
| Working identification | _Mammillaria mammillaris_        |
| Common name            | Woolly nipple cactus             |
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Grow-light position | **Proposed R5C3 · Bright.** Retain R5C3 from the earlier refinement. Preserve clear bright exposure and the probable Mammillaria identification. See the [relative-light placement guide](../../layouts/table-placement-research.md). Placement and intensity remain to be verified. |
...
- Seed can be collected from fully ripe fruit; offsets, if produced, can be
  rooted.
- Inspect the axils for mealybugs without forcing the tubercles apart.
- Photograph the next open flower beside a ruler because it is useful
