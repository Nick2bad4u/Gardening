...
| Kind                                 | Record                                                                   |
| ------------------------------------ | ------------------------------------------------------------------------ |
| Working species                      | Probable _Lithops salicola_ L.Bolus                                      |
| Family                               | Aizoaceae                                                                |
| Common / nursery names               | Living stones; Stone Faces                                               |
| Seller identification                | _Lithops_ spp.; no species or cultivar supplied                          |
| Profile scope                        | The two grey/green heads; rooted-individual count unverified             |
| Native range of the proposed species | Northern Cape to Free State, South Africa; collection provenance unknown |

The September 23 photographs favor _L. salicola_ for this appearance group.
The grey sides and relatively open windows are consistent with Keith Green's
description, but _L. olivacea_ and open-windowed forms of _L. lesliei_ remain
...
Kew accepts _Lithops salicola_ L.Bolus, published in 1936, as a succulent
perennial native to South Africa's Northern Cape and Free State. SANBI describes
its wild habitat as low limestone ridges or slopes, often beside brackish pans.
This is background for the proposed species, not a reason to add limestone or
...
alongside [probable _Lithops lesliei_](./lithops-lesliei.md), the tan/brown
appearance group. Both nursery pots were purchased at Home Depot in Howell,
Michigan, on September 21, 2026, and combined on September 23. Four visible
...
The two probable species share one root volume, but their visible leaf stages
still need individual inspection. Reassess the arrangement if their actual
watering needs diverge rather than assuming that shared soil synchronizes them.
...
light gradually; the proposed species is not a reason to force a darker color
or copy another container's exposure. Keep changes to firmness, scars, and the
base distinct from normal color differences between the two groups.

## Sources

- [Kew Plants of the World Online: _Lithops salicola_](https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:362486-1) — accepted name, 1936 publication, family, and native range; checked September 23, 2026.
- [SANBI Red List: _Lithops salicola_](https://redlist.sanbi.org/species.php?species=85-75) — wild habitat and the October 3, 2018 national assessment; checked September 23, 2026.
