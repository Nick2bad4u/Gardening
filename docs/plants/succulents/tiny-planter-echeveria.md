# Pale rosette echeveria

- Inventory: Succulent-10A — _Echeveria_ sp. — species and cultivar unresolved
- Label ID: `#6`
- Tracker ID: `P30`
- Status: Active; shared planter component
- Visual description: Pale blue-white powdery rosettes with overlapping, pointed fleshy leaves; several rosettes are visible within the same tiny planter.
- Interesting fact: An Echeveria can make new rosettes beside its base; as older lower leaves fall, the short stem beneath the original rosette becomes easier to see.
- Identification: **Provisional genus-level foliage match; species and cultivar unresolved**
...
The other component pages are [coppertone-type sedum](./tiny-planter-coppertone-sedum.md) and [paddle kalanchoe](./tiny-planter-paddle-kalanchoe.md). All share **#6 / P30**, one root volume, and one watering and weight history.
...
- [NC State Extension Plant Toolbox: _Echeveria_](https://plants.ces.ncsu.edu/plants/echeveria/) — genus diversity, morphology, and general culture.
