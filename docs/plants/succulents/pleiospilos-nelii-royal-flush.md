...
| Kind                | Name                                         |
| ------------------- | -------------------------------------------- |
| Accepted species    | _Pleiospilos nelii_                          |
| Cultivar            | 'Royal Flush'                                |
| Common name         | Split rock                                   |
| Cultivar wild range | None; the species is native to South Africa. |

'Royal Flush' is a pink-to-purple selection of the split rock. Each active
...
- Keep a consistent photographed orientation until the active leaf cycle is
  understood; routine rotation can begin later if growth remains even.
