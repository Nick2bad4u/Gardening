...
stem color can be normal in strong light; crisp beige patches after a move are
sunburn.

## Propagation and watch points

- Stem cuttings root readily. Let a fresh cut dry briefly, then place it in an
  airy medium and delay heavy watering until roots begin.
- It is very suitable for bonsai-style pruning, but wired branches scar easily.
- Dropping many plump green leaves at once often follows a sudden environmental
  change or wet roots; gradual wrinkling usually indicates use of stored water.
- Scale and mealybugs favor woody branch junctions.
- This species will eventually outgrow the shared planter unless it is pruned or
  moved.
