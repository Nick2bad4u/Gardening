...
- Tracker ID: `P20`
- Visual description: Upright fuzzy succulent with broad spoon-shaped leaves that age from silver to copper-brown.
- Interesting fact: New leaves can emerge pale and silvery before developing the copper color behind its common name.
- Acquired from: Gerych's Greenhouse, as part of the mixed succulent planter
- Acquired on: 2026-07-27
- Identification: **high**
- Photo archive: [licensed species-reference images](../../../assets/plants/kalanchoe-orgyalis/)

## Names and identity

| Kind                       | Name                                                                |
| -------------------------- | ------------------------------------------------------------------- |
| Accepted botanical name    | _Kalanchoe orgyalis_ Baker                                          |
| Common and trade names     | Copper spoons, cinnamon bear, leather plant, shoe-leather kalanchoe |
...
contribute. Use stem spacing and the health of the newest leaves too.

## Propagation, pests, and toxicity

- Stem cuttings root easily after the wound dries. Individual leaves can
  propagate, but a stem gives a faster usable plant.
- Scale and mealybugs hide at the felted leaf axils; inspect without scrubbing.
- Sudden leaf drop can follow waterlogged roots, cold, or a major move. A few
  old lower leaves drying is ordinary turnover.
- As a _Kalanchoe_, it should be treated as toxic to pets and people if eaten.
  Keep trimmings out of reach and out of animal-accessible compost.
- It will eventually compete with both the echeveria and silver teaspoons for
...
- [International Plant Names Index record](https://www.ipni.org/n/274427-1)
