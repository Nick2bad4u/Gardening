...
- Label ID: `H3` — reserved before arrival
...
- Rotate 90° weekly under the fixed grow light after the `H3` label is attached,
...
- [GBIF Backbone Taxonomy: _Sempervivum_](https://www.gbif.org/species/2985948)
