...
tracked planter, with only broad component-level working IDs. Current measured
pot sizes, replacement-medium composition, weights, and dimensions are not yet
logged.
