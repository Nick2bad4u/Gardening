...
**September 21 plan, clarified September 22:** P31/P32 will move to a **north-facing living-room window**, using the purchased **FECiDA 54 W six-tube clip light with two owned Juhefa three-head fixtures**, each seller-rated about **10 W total**. The separate **Diivoo lamp is optional**, with actual input wattage unverified. The [equipment record](./equipment/inventory.md#lights-and-controls) identifies the models; the FECiDA's September 23 delivery estimate was last checked September 21. Receipt, the move, and installation remain pending; final distances, settings, and measured leaf-level exposure remain unknown. Use the [living-room measurement trial](./layouts/table-placement-research.md#planned-living-room-window-and-leds) with **all lights actually used operating together** after dark, assessing daylight separately. An optional Diivoo on/off comparison can show whether it fills a gap. The listed 12-hour timer is the proposed first trial, not an applied setting. Retain inferred total-light comparisons of 4–6 DLI for Peperomia and 6–8 for Tricolor oyster plant, acclimate gradually, and judge compact new growth and color. After moving, observe the new room's root-zone drying, temperature, humidity, and airflow instead of assuming the cactus room's conditions carry over. A move alone does not reset weighing references or establish that water is due.
