...
**September 21 plan:** P31/P32 will move to a **north-facing living-room window**, using the newly purchased **FECiDA 54 W six-tube clip light alongside both owned 10 W LED bars and the separate owned 10 W LED light**. The [equipment record](./equipment/inventory.md#lights-and-controls) distinguishes the September 23 delivery estimate from confirmed receipt; the move and installation remain pending. Existing light models, final distances, settings, and leaf-level exposure remain unknown. Use the [living-room measurement trial](./layouts/table-placement-research.md#planned-living-room-window-and-leds) with all four fixtures on together after dark, assessing daylight separately. The FECiDA's listed 12-hour timer is the proposed first trial, not an applied setting. Retain inferred starting comparisons of 4–6 DLI for Peperomia and 6–8 for Tricolor oyster plant, acclimate gradually, and judge compact new growth and color. After moving, observe the new room's root-zone drying, temperature, humidity, and airflow instead of assuming the cactus room's conditions carry over. A move alone does not reset weighing references or establish that water is due.
