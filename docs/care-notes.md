...
**September 21 plan:** P31/P32 will move to a **north-facing living-room window**, with two owned 10 W LED bars and another owned 10 W LED light proposed as supplements. The move and light installation are pending; models, distances, runtime, and leaf-level exposure remain unknown. Use the [living-room measurement trial](./layouts/table-placement-research.md#planned-living-room-window-and-leds) before choosing the contemplated 20 W three-head upgrade. Retain inferred starting comparisons of 4–6 DLI for Peperomia and 6–8 for Tricolor oyster plant, acclimate gradually, and judge compact new growth and color. After moving, observe the new room's root-zone drying, temperature, humidity, and airflow instead of assuming the cactus room's conditions carry over. A move alone does not reset weighing references or establish that water is due.
