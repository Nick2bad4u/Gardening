...
The patent describes a 2012 cross between unnamed selections and subsequent selection for compact, spreading growth and variegated foliage. The maintained name remains at genus-plus-cultivar level so the patent's botanical designation is preserved as provenance without silently resolving changing species usage. A seller name is not independent authentication of this individual plant.
...
| Tracking    | Weigh the same assembly each time without the saucer. Record actual weights and watering only when performed; missing values remain missing.                                                                                                                              |
...
- If shoots become long and bare, assess light and growth habit before changing water frequency. Occasional pinching is an option for a fuller plant, not a required daily task.
...
- Owner-supplied Amazon order and pot screenshots, September 19, 2026: The Succulent Cult's Nanouk title and 2-inch starter size; D'vine Dev `27-C-Z-K`, 4-inch Blush Mauve pot. These are private purchase records, not photographs of an established planting.
