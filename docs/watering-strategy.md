...
Updated: 2026-09-19. This guide explains the collection's care decisions, the checked-in logger 5.26.0 behavior, and the current daily-report policy. It is a strategy reference, not a recommendation to water particular pots today.
...
| P32 / #8, Nanouk tradescantia                                                               | Let the upper mix dry somewhat, then water and drain when plant-specific readiness supports it. Do not require a cactus-level dry root ball, a historical dry-reference hit, or a sustained plateau before it can need water. The tracker withholds a weight-only water date; daily reports keep it in the manual Check-only exception, with no automatic water/feed recipe. See the [Nanouk profile](./plants/houseplants/tradescantia-nanouk.md). |
...
| P31 / #7, four-succulent planter                                                            | Cubic Frost, Coppertone, Deminuta, and Ruby Slippers have individual profiles but one shared root volume and one P31 history. Use the actual whole-planter dry-down and component readiness; do not assign four watering decisions or borrow the old #2/#6 references. Active enrollment supplies no measured baseline or completed watering.                                                                                                       |
