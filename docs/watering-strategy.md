...
Updated: 2026-09-23. This guide explains the collection's care decisions, the maintained logger behavior, and the current daily-report policy. It is a strategy reference, not a recommendation to water particular pots today.
...
P35/P36 were repotted and photographed September 23 into their chosen Blush Mauve and speckled-brown pots, both on setup 2 with 80% Molly's Succulent Mix plus 20% added perlite. Routine weights were 1247 g and 713.5 g respectively; the owner checked Dry and firm. These readings are not verified dry baselines. No Water event appears in either repot batch, and prior watering remains unknown. Keep both mesemb pots outside automatic feed/plain-water alternation; repotting creates no feeding event.
