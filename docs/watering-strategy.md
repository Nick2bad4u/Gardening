...
Updated: 2026-09-20. This guide explains the collection's care decisions, the maintained logger behavior, and the current daily-report policy. It is a strategy reference, not a recommendation to water particular pots today.
...
| P33 / #9, Peperomia Bicolor                                                                 | Let the medium partially dry while avoiding prolonged whole-pot drought. Check the upper mix and accessible root zone; a dry surface over wet roots is not readiness. Keep this as a manual moisture-check exception: a cactus plateau, old dry reference, or weight-only date does not establish the needed condition. See the [Peperomia profile](./plants/houseplants/peperomia-obtipan-bicolor.md) and its RHS/extension sources. |
| P34 / #10, Tricolor oyster plant                                                            | Check that the upper 1–2 inches have dried, scaled to the actual pot and root-ball depth once measured, with working drainage and no persistent saturation below. Do not wait for prolonged cactus-style whole-pot drought. Weight trends support the manual check rather than replace it. See the [oyster-plant profile](./plants/houseplants/tradescantia-spathacea-tricolor.md) and its extension guidance.                        |
