...
Updated: 2026-09-21. This guide explains the collection's care decisions, the maintained logger behavior, and the current daily-report policy. It is a strategy reference, not a recommendation to water particular pots today.
...
| P35 / #9, shared Lithops                                                                    | Inspect each owner-described pair and its leaf-replacement stage. A shared pot requires a compatible watering decision; do not infer synchronized stages. Shrinking old leaves, dry mass, and a plateau do not establish readiness. The prepared logger 5.29.0 suppresses forecast dates/windows and automatic watering dates. See the [Lithops profile](./plants/succulents/lithops-shared-planter.md) and its extension sources.    |
| P36 / #10, separate split rock                                                              | Probable Pleiospilos nelii, cultivar unconfirmed and explicitly not Royal Flush. Inspect inner-leaf condition, leaf replacement, and the actual substrate; do not apply generic cactus thresholds or automatic feeding alternation. Prepared source suppresses forecast dates/windows and automatic watering dates. See the [split-rock profile](./plants/succulents/pleiospilos-nelii.md) and its SANBI sources.                     |
...
P35/P36 are September 21 collection allocations with repotting still planned. Their current container details, medium, and last watering are unrecorded. Source enrollment in logger 5.29.0 is prepared; the last recorded live baseline is 5.28.0 / immutable 97 until cutover is verified. Keep both mesemb pots outside automatic feed/plain-water alternation; a new profile or planned repot creates no feeding event.
