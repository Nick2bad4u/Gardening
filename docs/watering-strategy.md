...
The logger's **Water date*** is conditional; the asterisk matters. Its **Dry-check window** describes uncertainty around approaching a previous mass reference. It is not the next weighing appointment. **Forecast basis** explains which observations support the forecast; it is not a separate care action.
...
| P21 / #3, money tree                                                                        | The archived nursery guidance uses the upper two inches of medium. Do not wait for the entire root ball to become cactus-dry. The working identity is _Pachira_ cf. _glabra_; the retail label identifies only the genus. The tracker withholds a weight-only water date. See the [money-tree profile](./plants/houseplants/pachira-glabra.md).                                                                                                                          |
| P31 / #7, Peperomia Bicolor                                                                 | Let the medium partially dry while avoiding prolonged whole-pot drought. Check the upper mix and accessible root zone; a dry surface over wet roots is not readiness. Keep this as a manual moisture-check exception: a cactus plateau, old dry reference, or weight-only date does not establish the needed condition. See the [Peperomia profile](./plants/houseplants/peperomia-obtipan-bicolor.md) and its RHS/extension sources.                                    |
| P32 / #8, Tricolor oyster plant                                                             | Check that the upper 1–2 inches have dried, scaled to the actual pot and root-ball depth once measured, with working drainage and no persistent saturation below. Do not wait for prolonged cactus-style whole-pot drought. Weight trends support the manual check rather than replace it. See the [oyster-plant profile](./plants/houseplants/tradescantia-spathacea-tricolor.md) and its extension guidance.                                                           |
...
| P35 / #9, shared Lithops                                                                    | Inspect each of the four visible heads and its leaf-replacement stage. A shared pot requires a compatible watering decision; do not infer synchronized stages. Shrinking old leaves, dry mass, and a plateau do not establish readiness. The maintained tracker policy suppresses forecast dates/windows and automatic watering dates. See the [Lithops profile](./plants/succulents/lithops-shared-planter.md) and its extension sources.                               |
| P36 / #10, separate split rock                                                              | Nursery-labelled Pleiospilos nelii, consistent with the photographs; no cultivar supplied and explicitly not Royal Flush. Inspect inner-leaf condition, leaf replacement, and the actual substrate; do not apply generic cactus thresholds or automatic feeding alternation. The maintained tracker policy suppresses forecast dates/windows and automatic watering dates. See the [split-rock profile](./plants/succulents/pleiospilos-nelii.md) and its SANBI sources. |
...
P35/P36 were repotted September 23 into their chosen Blush Mauve and speckled-brown pots, both on setup 2 with 80% Molly's Succulent Mix plus 20% added perlite. Routine weights were 1247 g and 713.5 g respectively; the repot checks recorded Dry medium and firm plants. These readings are not verified dry baselines. No Water event appears in either repot batch, and prior watering remains unknown. Keep both mesemb pots outside automatic feed/plain-water alternation; repotting creates no feeding event.
