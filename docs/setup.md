...
**Owner clarification, September 20:** the owner reports approximately **45–50% RH** and temperatures **in the 70s °F** near the collection. These are approximate current conditions, not a recorded day/night minimum or maximum. Three sensing points are reported: a probe described as on a glass table; a probe at plant height on the wall with about two inches of free lead allowing it to lean away from the wall; and an internal sensor in a body on a shelf about two feet from the cactus table. The equipment includes the probe-equipped VIVOSUN app-connected sensor and the A22 probe; the exact probe-to-device assignment is unconfirmed. The current glass-surface description is awaiting clarification because the old round display table is retired.
