...
The cacti and succulents spend dry weather outside and come inside when rain is
expected. The indoor setup is the main controlled growing area and will use a
grow light plus gentle simulated wind.
...
- the general location or climate for seasonal outdoor planning.
