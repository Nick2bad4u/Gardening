...
| Starter-12   | `C3`     | [_Astrophytum ornatum_](https://powo.science.kew.org/taxon/urn%3Alsid%3Aipni.org%3Anames%3A1063691-2)                          | Monk's hood cactus      | Labeled    | The rib shape, flecking, and long spines fit the label.                                                                                                         |
...
| `D3`     | Ming Thing              | Altman Reserve | 2026-07-15 |

The `D3` source record belongs to the plant whose original Altman Reserve label
read “_Opuntia cylindrica cristata_” or similar. That label remains provenance
evidence; the working identification is still _Cereus forbesii_ 'Ming Thing'.
...
| Inventory ID | Label ID               | Working identification                                                                                                 | Common name      | Confidence | Notes                                                                                                                         |
| ------------ | ---------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Succulent-01 | `#2`; formerly `C4-D4` | [_Echeveria pulidonis_](https://powo.science.kew.org/taxon/urn%3Alsid%3Aipni.org%3Anames%3A87059-2), or a close hybrid | —                | Probable   | Blue-gray rosette with fine red margins. A flower would help separate the species from lookalike hybrids.                     |
| Succulent-02 | `#2`; formerly `C4-D4` | [_Portulacaria afra_](https://powo.science.kew.org/taxon/urn%3Alsid%3Aipni.org%3Anames%3A699417-1)                     | Elephant bush    | High       | The yellow-green new growth may be a golden form such as ‘Aurea’, but the cultivar is not confirmed.                          |
| Succulent-03 | `#2`; formerly `C4-D4` | [_Kalanchoe bracteata_](https://plants.ces.ncsu.edu/plants/kalanchoe-bracteata/common-name/silver-teaspoons/)          | Silver teaspoons | Probable   | The powdery silver spoon-shaped leaves fit. _Kalanchoe hildebrandtii_ is a close lookalike; flowers would be useful evidence. |
| Succulent-04 | `#2`; formerly `C4-D4` | [_Kalanchoe orgyalis_](https://www.chicagobotanic.org/plant-information/plant-finder/kalanchoe-orgyalis-copper-spoons) | Copper spoons    | High       | This is the “brown spoons” plant. The copper felt on the leaves is normal.                                                    |
...
The owner explicitly assigned P31 / #7 to Peperomia Bicolor and P32 / #8 to Tricolor oyster plant on September 20. Archived Houseplant-02 and Succulent-11–14 retain research identities only, with no physical-label or tracker allocation. On **September 21**, the owner plans to move both houseplants to a **north-facing living-room window**, supplemented by two owned 10 W LED bars and another owned 10 W LED light. The move, lamp installation, models, distances, runtime, and exposure remain unconfirmed. The possible 20 W three-head upgrade is under consideration. Both plants need a gentler, measured starting exposure; the previously reported 18–22 app-estimated DLI far-table area is not automatically assigned to either purchase. See the [living-room plan and light comparison](./layouts/table-placement-research.md#planned-living-room-window-and-leds).
