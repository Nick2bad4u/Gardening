...
On **September 21**, the owner planned to move **P31 and P32 to a north-facing window in the living room** and confirmed purchasing a **FECiDA advertised 54 W six-tube clip grow light** for more even, stronger lighting alongside the existing lights. The **September 22 clarification** identifies those as **two Juhefa 10 W three-head fixtures**, with the separate **Diivoo now optional**. Juhefa's 10 W rating covers each entire fixture, not each bar; the Diivoo's actual input power is unverified. The September 21 Amazon order identified [FECiDA ASIN B0DHRHF2QV](https://www.amazon.com/dp/B0DHRHF2QV), with arrival estimated for **Wednesday, September 23**; delivery has not been rechecked. The earlier 20 W three-head alternatives were only considered. The [equipment record](../equipment/inventory.md#lights-and-controls) separates owner evidence, seller specifications, and unknown measurements. This is a separate destination from P21 Money Tree's recorded windowsill in the cactus room. Receipt, the move, mounting, stool assignments, timer settings, distances, actual power draw, and leaf-level coverage remain unconfirmed or unmeasured.

The six adjustable heads offer more positioning options for both canopies; more even coverage is an intended benefit to verify after setup. Both plants have bright-indirect nursery guidance; low-light survival is not the same as compact, well-colored growth. NC State qualifies Peperomia's low-light tolerance as especially applicable to non-variegated cultivars and warns that insufficient light can make oyster plants lanky and less purple. Give the oyster plant priority for the stronger measured position, while checking both canopies.
...
1. Measure **the FECiDA and both Juhefas operating together after dark**, adding the Diivoo only if it is included in the actual setup. Check representative upper, outer, and shaded leaf positions on both plants, recording distances, control settings, and runtime. The owned **UNI-T UT383BT with Android PPFD Meter** can provide useful estimates; retain raw lux and the app's spectrum setting, because conversion for the combined, partly unknown spectra is not a calibrated PAR measurement.
...
3. Once the FECiDA arrives, roughly three heads over each plant is a practical starting arrangement, adjusted around the existing lamps' coverage. Spread the heads over the canopy and outer foliage, then favor P32's stronger comparison range as readings justify. Moving lamps closer can raise local intensity while shrinking coverage. Follow the supplied clearance guidance and keep foliage clear of hot fixtures and cold window glass.
4. Adjust spacing and aim from the **combined readings**; the Juhefas and Diivoo list dimming, while FECiDA dimming remains unverified. Avoid concentrating all the beams on one small central patch. Compare the Diivoo on/off at the same leaf positions if deciding whether its extra coverage is useful; it is not required by the plan. Individual-fixture readings can help troubleshoot, but check the whole selected combination afterward. Acclimate gradually and watch for stretching, weaker color, bleaching, or scorch before considering any further purchase.
