...
P35 / #9 [Lithops shared planter](../plants/succulents/lithops-shared-planter.md) and P36 / #10 [Split rock](../plants/succulents/pleiospilos-nelii.md) were repotted and photographed September 23, but have no recorded final growing position. Four visible Lithops heads now share the D'vine Dev Blush Mauve pot, and the split rock uses the Thirtypot speckled-brown pot. Seller-selected sizes are 4.3 and 4.5 inches; the setup-2 ledger records 4.2 in round and 4 in round, respectively. The bathroom-counter photographs show a temporary repotting location. Keep both pots off the established placement grid until the owner records their growing locations. Actual drainage, usable internal depth, leaf-stage monitoring, and gradual light acclimation still need attention; no DLI target or measured exposure is assigned by this record.

## September 20 houseplant purchases

**P31 / #7 [Peperomia Bicolor](../plants/houseplants/peperomia-obtipan-bicolor.md)** and **P32 / #8 [Tricolor oyster plant](../plants/houseplants/tradescantia-spathacea-tricolor.md)** were purchased directly from Carlson's Greenhouses on September 20 in owner-reported six-inch nursery pots. Both tags specify **bright, indirect light**. The plants remain in those pots, on the room-side floor near the money tree. Their nursery medium, drainage arrangement, root condition, and previous watering or fertilizer history are unrecorded; wet foliage at purchase does not establish that the roots were watered.

Two Amazon Basics eight-inch pots with many drainage holes are the planned repot destinations; one is decorated, with its plant assignment unrecorded. The proposed medium combines airy, perlite-containing Carlson's greenhouse mix with Molly's Succulent Mix; no blend ratio or completed repot is recorded. The planned supports are [Bamworld pine stools](https://www.amazon.com/dp/B0GTHQRZSL), seller-listed at 7.8, 8.6 and 11.5 inches high. Receipt, assembly and measured heights remain unrecorded.

### Planned living-room window and LEDs

The living-room plan uses a **FECiDA advertised 54 W six-tube clip light**, purchased September 21, with **two existing Juhefa 10 W three-head fixtures** available for fill. Juhefa's 10 W rating covers each complete fixture. A separate **Diivoo** is optional and has unverified input power. The [equipment inventory](../equipment/inventory.md#lights-and-controls) lists exact models and seller specifications. This destination is separate from P21 Money Tree's north windowsill in the cactus room. Completed installation, applied settings, lamp distances, actual power draw and leaf-level exposure remain unrecorded.

The **September 22 planned layout** places the plants together at a **north-facing double glass sliding door**: **P32 oyster plant closest to the glass**, **P31 Peperomia on the smallest Bamworld stool**, and the **FECiDA clipped to a shelf**. Raising P31 should reduce shading by P32. The smallest stool's seller-listed height is 7.8 inches; assembled height, shelf height, lamp-to-leaf distances and P32's support are unmeasured. This remains a planned arrangement.

**Recommended first trial:** start with the **FECiDA alone for 12 daytime hours**, keeping the two Juhefas available as targeted fill if measurements show dim areas after adjusting the six heads. Leave the optional Diivoo out of that first trial. The six adjustable heads offer more positioning options for both canopies; more even coverage is an intended benefit to verify after setup. Both plants have bright-indirect nursery guidance; low-light survival is not the same as compact, well-colored growth. NC State qualifies Peperomia's low-light tolerance as especially applicable to non-variegated cultivars and warns that insufficient light can make oyster plants lanky and less purple. Give the oyster plant priority for the stronger measured position, while checking both canopies.
...
For the new room, a **12–14-hour daytime light window** is a reasonable initial trial, consistent with University of Minnesota foliage-houseplant guidance. The exact listings offer FECiDA 4/8/12/16/20-hour, Juhefa 4/8/12-hour, and optional Diivoo 4/8/12/18-hour timer choices, so **12 hours is a shared first setting**, with the selected lights aligned to the same daytime window. A 14-hour preset and restart behavior after interrupted power are not established. An applied timer setting has not been reported. The old cactus-room 13 h 15 m program does not establish this setup's runtime. The higher settled ranges above are optional comparisons, not a schedule for increasing light when growth is already satisfactory.
...
1. Measure **the FECiDA alone after dark** for the recommended first trial. Check representative upper, outer, and shaded leaf positions at each plant's actual canopy height, recording distances, control settings, and runtime. The owned **UNI-T UT383BT with Android PPFD Meter** can provide useful estimates; retain raw lux and the app's spectrum setting, because conversion for the lamps' spectra is not a calibrated PAR measurement.
2. Assess daylight separately over the day, including a dim or overcast day. A noon daylight-plus-LED reading multiplied by the lamp timer overstates variable daylight. Check whether P32 still shades P31 despite the stool; a small sideways offset may help preserve a view of the glass. Repeat the comparison as winter daylight changes.
3. For initial setup, roughly three FECiDA heads over each plant is a practical starting arrangement. Spread them over the canopy and outer foliage, then favor P32's stronger comparison range as readings justify. Adjust each head to the actual leaves: the stool changes P31's height, so equal head heights need not give equal clearances or exposure. Moving lamps closer can raise local intensity while shrinking coverage. Follow the supplied clearance guidance, keep foliage clear of hot fixtures and cold glass, and leave the sliding door's travel clear.
4. Reposition the FECiDA heads first. If a part of either canopy remains underlit, add **one Juhefa aimed at that area**, then remeasure with all selected lights on together. Add the second only if another gap remains. The Juhefas and Diivoo list dimming; FECiDA dimming remains unverified. Avoid concentrating beams on one central patch. The Diivoo remains optional; compare it on/off at the same leaf positions only if considering it later. Acclimate gradually and watch for stretching, weaker color, bleaching, or scorch before considering any further purchase.
...
**Money Tree moved to the north windowsill September 16.** The established arrangement has **29 containers on wood: 24 small pots at the front and five larger/shared containers behind them**, plus **#3 / P21 Money Tree on the windowsill**. The table photographs predate that move and the A3/F1 exchange below. #4 Kiwi remains at the rear left, and the vacated Money Tree spot stays open. The two September 20 houseplants are separate from this grid; their proposed living-room arrangement is described above.

The working footprint is **four tables in a 2 × 2 block, nominally 26 inches across × 32 inches toward the window**, excluding gaps and rails. That orientation is inferred from the photographs, not a new tape measurement. The former round glass table is no longer in use. The new tables' height has not been measured; the earlier pair was 18 inches high.

The drawings face the window: **window at top, open room at bottom, Mylar divider at left, white wall at right**. The window is still north-facing with weak supplementary daylight, and the two-foot room-end reflector remains absent.
...
**A3 Serpent Cactus and F1 Hook-spined Pincushion exchanged positions** after this comparison. All other recorded positions remain unchanged, including P21 Money Tree on the north windowsill. The illustrations predate the exchange; the written grid below shows the current positions. Different-height plants do not inherit the previous occupant's light reading, and the comparison did not measure the windowsill.

## Illustrated Views

These illustrations show the four-table display and separate Money Tree windowsill. **They predate the A3/F1 exchange; use the written grid below for current positions.** Plant shapes and sizes are illustrative. Light-priority badges describe care needs, not measured intensity.
...
The [illustration notes and limits](../../assets/layouts/2026-09-16-illustrated/image-prompts.md) record the style references and current-data constraints. The [original reference map](../../assets/layouts/2026-09-15-four-tables/estimated-light-map.png) and its [transparent-background copy](../../assets/layouts/2026-09-16-illustrated/estimated-light-map-transparent.png) remain available as downloads.
...
![Six-column four-row small-pot layout, row 1 nearest the room, D3 front-left and F2 front-right](../../assets/layouts/2026-09-15-four-tables/front-pots.png)
...
| B3    | [Indigo Wave](../plants/starter/myrtillocactus-geometrizans-indigo-wave.md) · _Myrtillocactus geometrizans_ 'Indigo Wave'               | **R1C5 · High.** Front row near the right. Keep clear exposure at its raised growing points.                                                                                                  |
...
| F1    | [Hook-spined pincushion](../plants/cacti/mammillaria-rekoi.md) · _Mammillaria_ cf. _rekoi_                                              | **R3C4 · Bright.** Now in A3's former slot. Compare its own growing surface; the previous occupant's reading does not establish this shorter plant's new exposure.                            |
...
This is a physical placement change, not a repot or watering event. **Keep the existing pot setups, wet/dry references and learned cycles.** Observe changed drying through useful weights; moving pots alone does not justify watering or weighing every pot daily. Money tree, Royal Flush, seasonal Kiwi and shared-container restrictions still apply.

## Sources

- **September 21–22 owner evidence:** planned P31/P32 move to the living room and FECiDA six-tube purchase. The owner confirmed the north-facing double glass sliding door, adjacent plants, P32 closest to the glass, P31 on the smallest stool, and FECiDA clipped to a shelf on September 22. The September 22 links identify the two existing Juhefa fixtures and separate Diivoo; the owner may omit the Diivoo, updating the initial plan to use all existing lights. Receipt, installation, distances, and applied settings remain unconfirmed.
- [Juhefa B0D7V5MBBW](https://www.amazon.com/dp/B0D7V5MBBW) and [Diivoo B0CBVFLNMV](https://www.amazon.com/dp/B0CBVFLNMV), inspected September 22: exact seller model, controls, and electrical fields, with evidence limits maintained in the [equipment inventory](../equipment/inventory.md#lights-and-controls). The Juhefa 10 W consumption claim applies per fixture; the Diivoo maximum-compatible-wattage field does not establish its input power.
- [FECiDA Amazon listing, ASIN B0DHRHF2QV](https://www.amazon.com/dp/B0DHRHF2QV), matched through the owner's order on September 21: seller per-tube ratings, spectrum components, and repeating 4/8/12/16/20-hour timer choices. The order's September 23 arrival date is an estimate.
