...
function initializeReport() {
    ...
    const themeButton = requiredElement("#theme-toggle", HTMLButtonElement);
    const themeLabel = requiredElement("#theme-label", HTMLElement);
    ...
    themeButton.addEventListener("click", () => {
        ...
        try {
            ...
            /* Theme works for this visit when storage is unavailable. */
        }
        updateThemeLabel();
    });
...
if (typeof document !== "undefined") initializeReport();
