...
The collection has **45 profile records: 44 active and one historical, across 34 tracked containers**. The current pages represent **42 botanical profile groups and two whole-planter overviews**; the [container guide](docs/containers.md) explains the four shared planters and their single observation histories. The Lithops and separate split rock were purchased at Home Depot in Howell, Michigan, on September 21 and repotted September 23. Probable _Lithops lesliei_ and probable _Lithops salicola_ have their own profiles within P35 / #9. The unreceived five-plant Amazon order is an [old plan under Guides](docs/old-plans/amazon-plant-order-2026-09.md); Amazon confirmed cancellation September 21 with no charge. Two houseplants bought directly at Carlson's Greenhouses on September 20 in owner-reported six-inch nursery pots have separate [profiles and IDs](docs/collection.md#september-20-carlsons-greenhouses-houseplants): #7 / P31 Peperomia Bicolor and #8 / P32 Tricolor oyster plant. The owner confirms two Amazon Basics eight-inch destination pots with many drainage holes; placement on separate floor pot stools is planned, off the tables; no completed repot or move is reported, and actual positions remain unmeasured. One destination pot is the previously decorated pot; its specific plant assignment is unconfirmed.
...
- [Containers and shared planters](docs/containers.md) — botanical members, permanent P-IDs, labels, setups, and one history per pot; [container directory](https://nick2bad4u.github.io/Gardening/containers/)
...
- [Watering quick guide](docs/watering-quick-guide.md) — when to water each plant group, when to wait, and why
- [Detailed watering strategy](docs/watering-strategy.md) — how references, curves, readiness, and plant-specific exceptions guide watering decisions
...
- [Table placement guide](docs/layouts/table-placement-research.md) — the established 30-container arrangement, two new houseplants with placement pending, light maps, and reading sheet; also [on the website](https://nick2bad4u.github.io/Gardening/setup/placement/)
...
The public website is built with Astro from the maintained Markdown and reviewed JSON records. The [homepage](https://nick2bad4u.github.io/Gardening/) connects the [plant directory](https://nick2bad4u.github.io/Gardening/plants/), [container directory](https://nick2bad4u.github.io/Gardening/containers/), [tracker](https://nick2bad4u.github.io/Gardening/tracker/), [current placement](https://nick2bad4u.github.io/Gardening/setup/placement/), [care guides](https://nick2bad4u.github.io/Gardening/guides/), and [photos](https://nick2bad4u.github.io/Gardening/photos/). Each plant profile has its own URL; container pages connect botanical members with the one observation history for their shared pot.
