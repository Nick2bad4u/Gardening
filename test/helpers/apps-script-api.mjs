...
export function appsScriptApi(context) {
    ...
    const functions = {
        ...
        installDailyCareDashboard: null,
        ...
        normalizeWebHistoryFilters_: null,
        ...
        webHistoryDetails_: null,
        webHistoryDetailValue_: null,
        webHistoryTimestamp_: null,
        webPlantWeightReadModel_: null,
        webWeightReadModelsFromRows_: null,
