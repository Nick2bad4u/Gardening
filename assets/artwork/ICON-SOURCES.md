...
The September 22 garden launcher set adds eleven original symbols for Home, Tracker, Plants, Pots, Photos, Guides, Setup, Equipment, Placement, Report Archive, and Search. Each pairs a distinct semantic illustration and colored square background with a mask-safe central composition. These remain native 64-unit vectors; publication derives larger PNG icons from their standalone exports. Existing Full Report and Pocket Report artwork is unchanged.
